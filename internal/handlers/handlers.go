...
import (
	...
	"github.com/Sergio-dot/bookings/internal/driver"
	"github.com/Sergio-dot/bookings/internal/forms"
	"github.com/Sergio-dot/bookings/internal/helpers"
	"github.com/Sergio-dot/bookings/internal/models"
	"github.com/Sergio-dot/bookings/internal/render"
	"github.com/Sergio-dot/bookings/internal/repository"
	"github.com/Sergio-dot/bookings/internal/repository/dbrepo"
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	err := r.ParseForm()
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "could not parse reservation form")
		http.Redirect(w, r, "/", http.StatusSeeOther)
		return
	}
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "could not parse start date")
		http.Redirect(w, r, "/", http.StatusSeeOther)
		return
	}
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "could not parse end date")
		http.Redirect(w, r, "/", http.StatusSeeOther)
		return
	}
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "could not get roomID")
		http.Redirect(w, r, "/", http.StatusSeeOther)
		return
	}
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "could not insert reservation into database")
		http.Redirect(w, r, "/", http.StatusSeeOther)
		return
	}
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "could not insert room restriction")
		http.Redirect(w, r, "/", http.StatusSeeOther)
		return
	}
	...
	htmlMessage := fmt.Sprintf(`
		...
		Dear %s: <br>
		This is to cofirm your reservation from %s to %s.
...
// PostAvailability posts to the search availability page
...
func (m *Repository) AvailabilityJSON(w http.ResponseWriter, r *http.Request) {
	// need to parse request body (for testing purposes)
	err := r.ParseForm()
	if err != nil {
		// could not parse form, return appropriate json
		resp := jsonResponse{
			OK:      false,
...
// BookRoom takes url parameters, builds a sessional variable, and redirects user to make reservation page
...
// AdminShowReservation shows the reservation details in the admin tool
